...
int main(int argc, char** argv) {
    ...
    if (argc < 3) {
        ...
        std::cout << "FIGURAS: cubo, esfera, cono, cilindro, toroide, taza" << std::endl;
        return 1;
    }
    ...
    if (strcmp(argv[2], "cubo") == 0) {
        ...
        figura = 4;
    } else if (strcmp(argv[2], "taza") == 0) {
        figura = 5;
    } else {
        std::cerr << "Error: Figura no reconocida. Opciones válidas: cubo, esfera, cono, cilindro, toroide, taza" << std::endl;
        return 1;
    }
